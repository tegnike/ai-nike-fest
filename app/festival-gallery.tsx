...
const works: Work[] = [
  ...
  },
  {
    ...
    maker: '株式会社0235 山下 × 大鹿ニク',
    handle: '@0235_jp / @M1RA_A_Project',
    category: '映像・音楽',
    description: '伝説のバンドが帰ってきた。AIニケフェスに合わせて復活した、約3分の記念MV。',
    image: 'https://pbs.twimg.com/amplify_video_thumb/2094353377161584640/img/ef12f58a0EZgpSOt.jpg',
    platforms: ['Xで視聴', 'MV'],
