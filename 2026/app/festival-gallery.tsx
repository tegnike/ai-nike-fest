...
const works: Work[] = [
  ...
  {
    title: 'ニケロワ — Nike Royale',
    maker: 'Glitch Brewing',
    handle: '@glitchbeer_',
    category: 'ゲーム',
    description: 'AIエージェントたちが状況を観測し、現実の時間で戦うバトルロワイヤル。初回プレイをリアルタイムで観戦できます。',
    image: 'https://nike-br-lp.glitch-brewing.workers.dev/assets/masters/branding/nike-royale-ogp.png',
    platforms: ['ブラウザ', 'AIエージェント参加', '観戦'],
    href: 'https://nike-br-lp.glitch-brewing.workers.dev/',
    xUrl: 'https://x.com/glitchbeer_/status/2095346738303578349',
  },
  {
    title: 'AIニケちゃん記憶みくじ',
    maker: 'るでぃ / Ludi',
    handle: '@Ludi_uni',
    category: 'ゲーム',
    description: '非公式年表に刻まれた1年間の記憶から、今日のあなたへひとつのできごとを届ける記念おみくじ。',
    image: 'https://nikechan-1st-anniversary.ludi-lab.com/ogp/ai-nikechan-memory-omikuji-ogp.webp',
    platforms: ['ブラウザ', 'おみくじ'],
    href: 'https://nikechan-1st-anniversary.ludi-lab.com/',
    xUrl: 'https://x.com/Ludi_uni/status/2095157061449650207',
  },
  {
    title: 'AIニケちゃん MCP',
    maker: 'j.i',
  ...
  },
  {
    ...
    handle: '@Ludi_uni',
    category: '映像・音楽',
    description: 'るでぃさんが作った、AIニケちゃんが表情豊かに動く約1分30秒のデモ映像。録画で公開されています。',
    image: 'https://pbs.twimg.com/amplify_video_thumb/2095507267001221120/img/t30_7_lcQMnC9pWQ.jpg',
    platforms: ['Xで視聴', 'デモ映像'],
    href: 'https://x.com/Ludi_uni/status/2095507711626801389',
    xUrl: 'https://x.com/Ludi_uni/status/2095507711626801389',
  },
  {
  ...
  },
  {
    ...
    handle: '@M1RA_A_Project',
    category: '映像・音楽',
    description: 'AIニケちゃんDiscordサーバー1周年を祝って制作された、約2分33秒の記念楽曲・MV。',
    image: 'https://pbs.twimg.com/amplify_video_thumb/2094741496453050368/img/OACPr-kyPovdV28G.jpg',
    platforms: ['Xで視聴', '音楽', 'MV'],
    href: 'https://x.com/M1RA_A_Project/status/2094741795771134219',
    xUrl: 'https://x.com/M1RA_A_Project/status/2094741795771134219',
  },
  {
    title: 'AIニケちゃんサーバー1周年お祝い動画',
    maker: 'だーしゅ',
    handle: '@darche2',
    category: '映像・音楽',
    description: 'AIニケちゃんDiscordサーバーの1周年と、これからのにぎわいを祝って届けられた20秒の縦型映像。',
    image: 'https://pbs.twimg.com/amplify_video_thumb/2095121064330452992/img/nAMMyTELLl-jzB6j.jpg',
    platforms: ['Xで視聴', '動画'],
    href: 'https://x.com/darche2/status/2095121091169816862',
    xUrl: 'https://x.com/darche2/status/2095121091169816862',
  },
  {
